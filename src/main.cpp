...
//    //delay(1000);
    ...
    lv_obj_add_event_cb(objects.sw_pump, event_handler,LV_EVENT_ALL,pLED2);
  
    lv_timer_create(update_adc34_meter,200,NULL);
    lv_timer_create(update_adc34_val,200,NULL);
    lv_timer_create(update_adc33_val,100,NULL);
    lv_timer_create(get_sw_state, 300, pSW);
